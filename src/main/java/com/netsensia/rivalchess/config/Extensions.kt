...
enum class Extensions(val value: Int) {
    FRACTIONAL_EXTENSION_FULL(8), FRACTIONAL_EXTENSION_THREAT(8), FRACTIONAL_EXTENSION_CHECK(8), FRACTIONAL_EXTENSION_RECAPTURE(8), FRACTIONAL_EXTENSION_PAWN(8), RECAPTURE_EXTENSION_MARGIN(50), LAST_EXTENSION_LAYER(4);
