...
public final class RivalTester {
    ...
    public static void setBoardState(EngineChessBoard engineBoard, int[] moves, int moveNum) throws EvaluationFlipException {
    ...
    public static void rivalVersusRival() throws EvaluationFlipException {
