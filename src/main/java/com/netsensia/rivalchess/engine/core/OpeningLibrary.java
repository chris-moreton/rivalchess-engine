...
public class OpeningLibrary
{
	...
	static {
		...
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3, "a7a6", 604));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6, "f1b5", 599));
		openings.add(new OpeningPosition(D2D4_G8F6, "g1f3", 568));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3, "b8c6", 490));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5, "b1c3", 487));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4, "g7g6", 457));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5, "a7a6", 439));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6, "b1c3", 394));
		openings.add(new OpeningPosition(START, "g1f3", 378));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6, "d2d4", 371));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_E7E6, "b1c3", 370));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4, "c5d4", 368));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4, "f3d4", 366));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6, "b5a4", 361));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_E7E6_B1C3, "f8b4", 320));
		openings.add(new OpeningPosition(E2E4, "c7c6", 320));
		openings.add(new OpeningPosition(C2C4, "g8f6", 315));
		openings.add(new OpeningPosition(D2D4_D7D5, "g1f3", 311));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4, "g8f6", 306));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3, "f8g7", 291));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4_G8F6, "e1g1", 285));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7, "e2e4", 284));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3, "e7e6", 284));
		openings.add(new OpeningPosition(E2E4_C7C6, "d2d4", 272));
		openings.add(new OpeningPosition(C2C4, "e7e5", 271));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4, "d7d6", 270));
		openings.add(new OpeningPosition(E2E4_C7C6_D2D4, "d7d5", 270));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4, "c7c6", 261));
		openings.add(new OpeningPosition(D2D4_D7D5_G1F3, "g8f6", 244));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3, "f8b4", 242));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3, "g8f6", 232));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_E7E6, "g1f3", 232));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4, "g8f6", 229));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6, "b1c3", 228));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3, "e7e6", 224));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_E7E6, "d2d4", 214));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_E7E6_D2D4, "c5d4", 213));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_E7E6_D2D4_C5D4, "f3d4", 212));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4, "e4e5", 211));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3, "g7g6", 203));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4, "b7b6", 198));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_A7A6, "c1e3", 188));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4, "c7c5", 182));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4, "e7e6", 179));
		openings.add(new OpeningPosition(E2E4, "d7d6", 177));
		openings.add(new OpeningPosition(G1F3, "g8f6", 173));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_D7D5, "c2c4", 171));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6, "f1c4", 170));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6_G1F3_E8G8, "f1e2", 166));
		openings.add(new OpeningPosition(D2D4, "f7f5", 166));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5, "b1d2", 165));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4_G8F6_E1G1, "f8e7", 163));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3, "e7e5", 161));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_E7E6_B1C3_F8B4, "d1c2", 161));
		openings.add(new OpeningPosition(E2E4_C7C5, "c2c3", 161));
		openings.add(new OpeningPosition(C2C4_E7E5, "b1c3", 160));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_D7D5_C2C4_C7C6, "b1c3", 159));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3, "g8f6", 159));
		openings.add(new OpeningPosition(E2E4_C7C5, "b1c3", 158));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_D7D5, "b1c3", 156));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_E7E5, "d4b5", 155));
		openings.add(new OpeningPosition(E2E4_D7D6_D2D4, "g8f6", 153));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4_E7E6, "b1c3", 153));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_E7E5_D4B5, "d7d6", 152));
		openings.add(new OpeningPosition(E2E4_D7D6, "d2d4", 152));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4_E4E5, "c7c5", 151));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5, "e4e5", 151));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_G8F6, "c1g5", 147));
		openings.add(new OpeningPosition(C2C4_G8F6, "b1c3", 147));
		openings.add(new OpeningPosition(D2D4, "e7e6", 145));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_E4E5, "c7c5", 144));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4_G8F6_E1G1_F8E7, "f1e1", 143));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4_G8F6_E1G1_F8E7_F1E1_B7B5, "a4b3", 142));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4_G8F6_E1G1_F8E7_F1E1, "b7b5", 142));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6_G1F3_E8G8_F1E2, "e7e5", 142));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_A7A6, "c1g5", 142));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_C7C5, "d4d5", 141));
		openings.add(new OpeningPosition(E2E4_D7D6_D2D4_G8F6, "b1c3", 140));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_B7B6, "g2g3", 140));
		openings.add(new OpeningPosition(E2E4, "d7d5", 140));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6_G1F3, "e8g8", 137));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_E7E5_D4B5_D7D6_C1G5, "a7a6", 135));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4_E4E5_C7C5, "a2a3", 133));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_A7A6_C1G5, "e7e6", 133));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_D2D4, "e5d4", 133));
		openings.add(new OpeningPosition(E2E4_D7D5, "e4d5", 130));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6, "d2d4", 130));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4_C7C6, "g1f3", 129));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_G7G6_C2C4, "f8g7", 128));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4_E4E5_C7C5_A2A3_B4C3, "b2c3", 125));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4_E4E5_C7C5_A2A3, "b4c3", 125));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_E7E5_D4B5_D7D6_C1G5_A7A6, "b5a3", 124));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6, "f2f3", 124));
		openings.add(new OpeningPosition(E2E4_D7D6_D2D4_G8F6_B1C3, "g7g6", 124));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_E7E5_D4B5_D7D6, "c1g5", 123));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3, "b8c6", 122));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3, "d7d5", 121));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3, "g7g6", 119));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6_F2F3, "e8g8", 117));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_A7A6_C1G5_E7E6, "f2f4", 116));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_E7E6_D2D4_C5D4_F3D4, "a7a6", 116));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_D7D5_B1C3_C7C6_E2E3, "b8d7", 115));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_G7G6_C2C4_F8G7, "b1c3", 114));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_D2D4_E5D4, "f3d4", 114));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4_C7C6_G1F3, "g8f6", 114));
		openings.add(new OpeningPosition(C2C4, "c7c5", 114));
		openings.add(new OpeningPosition(G1F3, "d7d5", 112));
		openings.add(new OpeningPosition(E2E4_C7C6_D2D4_D7D5_B1C3_D5E4, "c3e4", 110));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3, "d7d5", 110));
		openings.add(new OpeningPosition(E2E4_C7C6_D2D4_D7D5_B1C3, "d5e4", 110));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4, "d5c4", 110));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_D7D5_C2C4_C7C6_B1C3, "e7e6", 109));
		openings.add(new OpeningPosition(E2E4_C7C6_D2D4_D7D5, "b1c3", 109));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6, "c2c4", 109));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_G7G6, "c2c4", 108));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1C4, "g8f6", 108));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_D7D5_B1C3_C7C6, "c1g5", 107));
		openings.add(new OpeningPosition(E2E4_E7E5, "f2f4", 107));
		openings.add(new OpeningPosition(E2E4, "g8f6", 107));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6_F2F3_E8G8, "c1e3", 106));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4_E4E5_C7C5_A2A3_B4C3_B2C3, "g8e7", 106));
		openings.add(new OpeningPosition(C2C4_E7E5_B1C3, "g8f6", 106));
		openings.add(new OpeningPosition(E2E4_C7C5_B1C3, "b8c6", 105));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_D7D6, "c1g5", 104));
		openings.add(new OpeningPosition(E2E4_D7D5_E4D5, "d8d5", 102));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_E4E5_C7C5, "c2c3", 100));
		openings.add(new OpeningPosition(START, "f2f4", 98));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_A7A6, "f1e2", 97));
		openings.add(new OpeningPosition(C2C4_E7E5, "g2g3", 97));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4_E7E6_B1C3, "g8f6", 96));
		openings.add(new OpeningPosition(E2E4, "b8c6", 96));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6_B5A4_G8F6_E1G1_F8E7_F1E1_B7B5_A4B3, "e8g8", 95));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_D7D5, "c1f4", 94));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_E7E5_D4B5_D7D6_C1G5_A7A6_B5A3, "b7b5", 93));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_B7B6_G2G3_C8B7, "f1g2", 93));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_B7B6_G2G3, "c8b7", 93));
		openings.add(new OpeningPosition(D2D4_G8F6, "c1g5", 93));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_G8F6, "f3e5", 93));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_G7G6, "c1e3", 92));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_A7A6_C1E3, "e7e5", 91));
		openings.add(new OpeningPosition(D2D4_D7D5_C2C4_C7C6, "b1c3", 91));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5, "g8f6", 90));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6_G1F3_E8G8_F1E2_E7E5, "e1g1", 89));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_G7G6_C1E3, "f8g7", 89));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_G7G6_B1C3_F8G7_E2E4_D7D6, "g1f3", 88));
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_E7E6_B1C3_F8B4_D1C2, "e8g8", 88));
		openings.add(new OpeningPosition(E2E4_G8F6, "e4e5", 88));
		openings.add(new OpeningPosition(C2C4_E7E5_B1C3_G8F6, "g1f3", 87));
		openings.add(new OpeningPosition(E2E4_D7D5_E4D5_D8D5, "b1c3", 86));
		openings.add(new OpeningPosition(E2E4_G8F6_E4E5, "f6d5", 86));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_G8F6, "e4e5", 85));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_D7D6_C1G5, "e7e6", 85));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1D2, "g8f6", 84));
		openings.add(new OpeningPosition(E2E4_E7E5_F2F4, "e5f4", 84));
		openings.add(new OpeningPosition(C2C4_G8F6, "g2g3", 83));
		openings.add(new OpeningPosition(E2E4_C7C5, "d2d4", 83));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_D7D6_D2D4_C5D4_F3D4_G8F6_B1C3_G7G6_C1E3_F8G7, "f2f3", 82));
		openings.add(new OpeningPosition(C2C4, "e7e6", 82));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_G8F6_E4E5, "f6d7", 81));
		openings.add(new OpeningPosition(C2C4_E7E5_B1C3_G8F6_G1F3, "b8c6", 81));
		openings.add(new OpeningPosition(E2E4_C7C5_D2D4, "c5d4", 81));
		...
		openings.add(new OpeningPosition(D2D4_G8F6_C2C4_E7E6_B1C3_F8B4, "e2e3", 80));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_D7D5_B1C3, "f8e7", 79));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_F8B4_E4E5_C7C5_A2A3_B4C3_B2C3_G8E7, "d1g4", 78));
		openings.add(new OpeningPosition(E2E4_C7C5_G1F3_B8C6_D2D4_C5D4_F3D4_G8F6_B1C3_D7D6_C1G5_E7E6, "d1d2", 78));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1C3_G8F6_C1G5, "f8e7", 77));
		openings.add(new OpeningPosition(E2E4_E7E6_D2D4_D7D5_B1D2_G8F6, "e4e5", 77));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4_D7D5_B1C3_C7C6, "e2e3", 76));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_D7D5_C2C4, "e7e6", 76));
		openings.add(new OpeningPosition(D2D4_G8F6_G1F3_E7E6_C2C4, "d7d5", 76));
		openings.add(new OpeningPosition(E2E4_E7E5_G1F3_B8C6_F1B5_A7A6, "b5c6", 76));
		openings.add(new OpeningPosition(E2E4_C7C6_D2D4_D7D5, "e4e5", 76));
