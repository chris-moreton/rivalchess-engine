...
public final class EngineChessBoard {
    ...
    public boolean isSquareAttacked(final int attackedSquare, final boolean isWhiteAttacking) {
        if (isWhiteAttacking) {
            if ((m_pieceBitboards[RivalConstants.WN] & Bitboards.knightMoves[attackedSquare]) != 0 |
                    ...
                    (m_pieceBitboards[RivalConstants.WP] & Bitboards.blackPawnMovesCapture[attackedSquare]) != 0)
                return true;
        } else {
            if ((m_pieceBitboards[RivalConstants.BN] & Bitboards.knightMoves[attackedSquare]) != 0 |
                    ...
                    (m_pieceBitboards[RivalConstants.BP] & Bitboards.whitePawnMovesCapture[attackedSquare]) != 0)
                return true;
        }
    ...
    public int countAttackersWithBatteries(final int attackedSquare, boolean isWhiteAttacking) {
        ...
        if (isWhiteAttacking) {
            ...
            if ((m_pieceBitboards[RivalConstants.WN] & Bitboards.knightMoves[attackedSquare]) != 0)
                attackers += Long.bitCount(m_pieceBitboards[RivalConstants.WN] & Bitboards.knightMoves[attackedSquare]);
            if ((m_pieceBitboards[RivalConstants.WK] & Bitboards.kingMoves[attackedSquare]) != 0)
                attackers += Long.bitCount(m_pieceBitboards[RivalConstants.WK] & Bitboards.kingMoves[attackedSquare]);
            if ((m_pieceBitboards[RivalConstants.WP] & Bitboards.blackPawnMovesCapture[attackedSquare]) != 0)
                attackers += Long.bitCount(m_pieceBitboards[RivalConstants.WP] & Bitboards.blackPawnMovesCapture[attackedSquare]);
        } else {
            ...
            if ((m_pieceBitboards[RivalConstants.BN] & Bitboards.knightMoves[attackedSquare]) != 0)
                attackers += Long.bitCount(m_pieceBitboards[RivalConstants.BN] & Bitboards.knightMoves[attackedSquare]);
            if ((m_pieceBitboards[RivalConstants.BK] & Bitboards.kingMoves[attackedSquare]) != 0)
                attackers += Long.bitCount(m_pieceBitboards[RivalConstants.BK] & Bitboards.kingMoves[attackedSquare]);
            if ((m_pieceBitboards[RivalConstants.BP] & Bitboards.whitePawnMovesCapture[attackedSquare]) != 0)
                attackers += Long.bitCount(m_pieceBitboards[RivalConstants.BP] & Bitboards.whitePawnMovesCapture[attackedSquare]);
        }
    ...
    private long getBitboardPawnCaptureMoves(int bitRef, long[] bitboardMaskCapturePawnMoves, long bitboardPawnMoves) {
        ...
        if (this.m_isWhiteToMove) {
            if (movePiece == RivalConstants.WP) {
                ...
                if ((toMask & Bitboards.RANK_4) != 0 && (fromMask & Bitboards.RANK_2) != 0) {
                    ...
                    switch (compactMove & RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_FULL) {
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_QUEEN:
                            ...
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                this.pieceSquareValues[RivalConstants.WQ] += Bitboards.pieceSquareTableQueen[moveTo];
                            break;
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_ROOK:
                            ...
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                this.pieceSquareValues[RivalConstants.WR] += Bitboards.pieceSquareTableRook[moveTo];
                            break;
                        ...
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_BISHOP:
                            ...
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                this.pieceSquareValues[RivalConstants.WB] += Bitboards.pieceSquareTableBishop[moveTo];
                            break;
                    }
                    whitePawnValues -= RivalConstants.VALUE_PAWN;
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES) {
                ...
                if ((toMask | fromMask) == Bitboards.WHITEKINGSIDECASTLEMOVEMASK) {
                    ...
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        this.pieceSquareValues[RivalConstants.WR] += Bitboards.pieceSquareTableRook[Bitboards.F1] - Bitboards.pieceSquareTableRook[Bitboards.H1];
                    ...
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        this.pieceSquareValues[RivalConstants.WR] += Bitboards.pieceSquareTableRook[Bitboards.D1] - Bitboards.pieceSquareTableRook[Bitboards.A1];
                }
            }
            ...
            if (movePiece == RivalConstants.BP) {
                ...
                if ((toMask & Bitboards.RANK_5) != 0 && (fromMask & Bitboards.RANK_7) != 0) {
                    ...
                    switch (compactMove & RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_FULL) {
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_QUEEN:
                            ...
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                this.pieceSquareValues[RivalConstants.BQ] += Bitboards.pieceSquareTable[0][RivalConstants.BQ][moveTo];
                            break;
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_ROOK:
                            blackPieceValues += RivalConstants.VALUE_ROOK;
                            ...
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                this.pieceSquareValues[RivalConstants.BR] += Bitboards.pieceSquareTable[0][RivalConstants.BR][moveTo];
                            break;
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_KNIGHT:
                            blackPieceValues += RivalConstants.VALUE_KNIGHT;
                        ...
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_BISHOP:
                            ...
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                this.pieceSquareValues[RivalConstants.BB] += Bitboards.pieceSquareTable[0][RivalConstants.BB][moveTo];
                ...
                if ((toMask | fromMask) == Bitboards.BLACKKINGSIDECASTLEMOVEMASK) {
                    ...
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        this.pieceSquareValues[RivalConstants.BR] += Bitboards.pieceSquareTableRook[Bitboards.F1] - Bitboards.pieceSquareTableRook[Bitboards.H1]; // flipped H8 = H1
                    ...
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        this.pieceSquareValues[RivalConstants.BR] += Bitboards.pieceSquareTableRook[Bitboards.D1] - Bitboards.pieceSquareTableRook[Bitboards.A1]; // flipped A8 = A1
                }
            }
        ...
        do {
            ...
            if (promotionPiece != 0) {
                if (this.m_isWhiteToMove) {
                    ...
                    switch (promotionPiece) {
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_QUEEN:
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                pieceSquareValues[RivalConstants.WQ] -= Bitboards.pieceSquareTableQueen[toSquare];
                            this.m_pieceBitboards[RivalConstants.WQ] ^= toMask;
                            this.whitePieceValues -= RivalConstants.VALUE_QUEEN;
                            break;
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_BISHOP:
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                pieceSquareValues[RivalConstants.WB] -= Bitboards.pieceSquareTableBishop[toSquare];
                            this.m_pieceBitboards[RivalConstants.WB] ^= toMask;
                        ...
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_ROOK:
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                pieceSquareValues[RivalConstants.WR] -= Bitboards.pieceSquareTableRook[toSquare];
                            this.m_pieceBitboards[RivalConstants.WR] ^= toMask;
                    ...
                    switch (promotionPiece) {
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_QUEEN:
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                pieceSquareValues[RivalConstants.BQ] -= Bitboards.pieceSquareTableQueen[flippedToSquare];
                            this.m_pieceBitboards[RivalConstants.BQ] ^= toMask;
                            this.blackPieceValues -= RivalConstants.VALUE_QUEEN;
                            break;
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_BISHOP:
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                pieceSquareValues[RivalConstants.BB] -= Bitboards.pieceSquareTableBishop[flippedToSquare];
                            this.m_pieceBitboards[RivalConstants.BB] ^= toMask;
                        ...
                        case RivalConstants.PROMOTION_PIECE_TOSQUARE_MASK_ROOK:
                            if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                                pieceSquareValues[RivalConstants.BR] -= Bitboards.pieceSquareTableRook[flippedToSquare];
                            this.m_pieceBitboards[RivalConstants.BR] ^= toMask;
            ...
            if (movePiece == RivalConstants.WK) {
                if ((toMask | fromMask) == Bitboards.WHITEKINGSIDECASTLEMOVEMASK) {
                    ...
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        pieceSquareValues[RivalConstants.WR] += Bitboards.pieceSquareTableRook[Bitboards.H1] - Bitboards.pieceSquareTableRook[Bitboards.F1];
                } else if ((toMask | fromMask) == Bitboards.WHITEQUEENSIDECASTLEMOVEMASK) {
                    this.m_pieceBitboards[RivalConstants.WR] ^= Bitboards.WHITEQUEENSIDECASTLEROOKMOVE;
                    this.squareContents[Bitboards.A1] = RivalConstants.WR;
                    this.squareContents[Bitboards.D1] = -1;
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        pieceSquareValues[RivalConstants.WR] += Bitboards.pieceSquareTableRook[Bitboards.A1] - Bitboards.pieceSquareTableRook[Bitboards.D1];
                }
                break;
            } else if (movePiece == RivalConstants.BK) {
                if ((toMask | fromMask) == Bitboards.BLACKKINGSIDECASTLEMOVEMASK) {
                    ...
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        pieceSquareValues[RivalConstants.BR] += Bitboards.pieceSquareTableRook[Bitboards.H1] - Bitboards.pieceSquareTableRook[Bitboards.F1];
                } else if ((toMask | fromMask) == Bitboards.BLACKQUEENSIDECASTLEMOVEMASK) {
                    this.m_pieceBitboards[RivalConstants.BR] ^= Bitboards.BLACKQUEENSIDECASTLEROOKMOVE;
                    this.squareContents[Bitboards.A8] = RivalConstants.BR;
                    this.squareContents[Bitboards.D8] = -1;
                    if (RivalConstants.TRACK_PIECE_SQUARE_VALUES)
                        pieceSquareValues[RivalConstants.BR] += Bitboards.pieceSquareTableRook[Bitboards.A1] - Bitboards.pieceSquareTableRook[Bitboards.D1];
                }
                break;
            }
            break;
