...
public class ChessBoardConversion 
{
	...
	public static String getPgnMoveFromCompactMove(int move, String fen)
		...
		{
			case PROMOTION_PIECE_TOSQUARE_MASK_QUEEN : pgnMove += "=Q"; break;
			case PROMOTION_PIECE_TOSQUARE_MASK_KNIGHT : pgnMove += "=N"; break;
			case PROMOTION_PIECE_TOSQUARE_MASK_BISHOP : pgnMove += "=B"; break;
			case PROMOTION_PIECE_TOSQUARE_MASK_ROOK : pgnMove += "=R"; break;
		}
