...
JNIEXPORT jint JNICALL Java_libRivalLibrary_linearScale(JNIEnv* env, jclass cls, jint arg0, jint arg1, jint arg2, jint arg3, jint arg4) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rval = libRivalLibrary::linearScale(arg0, arg1, arg2, arg3, arg4);
        rarg = (jint)rval;
    } catch (...) {
