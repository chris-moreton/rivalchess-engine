...
public class RivalSearchTest {
    ...
    public void testNodeCount() throws IllegalFenException, InterruptedException {
        ...
        assertNodeCount("3r2k1/ppp2ppp/6q1/b4n2/3nQB2/2p5/P4PPP/RN3RK1 b - -", 113110);
        ...
        assertNodeCount("rnbqkb1r/ppppp1pp/7n/4Pp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 3", 62412);
