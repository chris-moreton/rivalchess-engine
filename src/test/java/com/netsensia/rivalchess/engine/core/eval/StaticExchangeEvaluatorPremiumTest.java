...
public class StaticExchangeEvaluatorPremiumTest extends TestCase {
    ...
    public void testStaticExchangeEvaluation() throws IllegalFenException, InvalidMoveException {
        assertSeeScore("4k3/p1pprpb1/bnr1p3/3QN1n1/1p1NP1p1/7p/PPPBBPPP/R3K2R w KQ - 0 1", "d5e6", PieceValue.getValue(Piece.PAWN) - PieceValue.getValue(Piece.QUEEN));

        // winning rook capture - black rook can't recapture safely
        assertSeeScore("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", "b4f4", PieceValue.getValue(Piece.PAWN));

        assertSeeScore("4k2r/p1ppqpb1/bnr1p3/3PN1n1/1p2P1p1/2N2Q1p/PPPBBPPP/R3K2R w KQk - 0 1", "d5e6", 0);

        assertSeeScore("5k2/5p1p/p3B1p1/P5P1/3K1P1P/8/8/8 b - -", "f7e6", PieceValue.getValue(Piece.BISHOP));
        ...
        assertSeeScore("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", "e5d7", PieceValue.getValue(Piece.PAWN) - PieceValue.getValue(Piece.KNIGHT));
        assertSeeScore("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", "f3f6", PieceValue.getValue(Piece.KNIGHT) - PieceValue.getValue(Piece.QUEEN));
    }
