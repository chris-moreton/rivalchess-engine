...
class SearchTest {
    ...
    fun testMateIn8ToCheckmate_problematic_1() {
        // should be mate 7
        solveForMate("8/8/1K6/4q3/8/7k/8/8 b - - 0 1", "e5d5", willMateIn(14))
        // should be mate 7
        solveForMate("8/8/8/4q3/2K5/8/6k1/8 b - - 0 1", "g2f3", willMateIn(9))
        // should be mate 6
        solveForMate("8/8/8/3q4/8/2K2k2/8/8 b - - 0 1", "f3e4", willMateIn(7))
        // should be mate 7
        solveForMate("8/8/8/3q4/1K4k1/8/8/8 b - - 0 1", "g4f3", willMateIn(8))
    }
    ...
    fun testMateIn8ToCheckmate_problematic_2() {
        // should be mate 8
        solveForMate("8/8/3q4/8/1K6/7k/8/8 w - - 0 1", "b4c4", willBeMatedIn(12))
        // should be mate -4
        solveForMate("8/8/8/2q5/8/2K2k2/8/8 w - - 0 1", "c3b3", willBeMatedIn(6))
        // should be mate 8
        solveForMate("8/8/8/1K1q4/8/7k/8/8 w - - 0 1", "b5b4", willBeMatedIn(10))
    }
    ...
    fun testMateIn8ToCheckmate_problematic_3() {
        // should be mate 9
        solveForMate("8/8/8/8/2K5/7k/1q6/8 b - - 0 1", "h3g4", willMateIn(16))
        // should be mate 8
        solveForMate("8/8/8/4q3/1K6/7k/8/8 b - - 0 1", "e5d4", willMateIn(21))
        // should be mate 8
        solveForMate("8/8/8/3q4/K7/7k/8/8 b - - 0 1", "d5c6", willMateIn(15))
    }
    ...
    fun testMateIn8ToCheckmate_problematic_4() {
        // should be mate 6
        solveForMate("8/8/8/4q3/8/3K4/5k2/8 b - - 0 1", "e5d5", willMateIn(11))
        // should be mate 8
        solveForMate("8/8/3q4/1K6/8/7k/8/8 b - - 0 1", "d6c7", willMateIn(15))
        // should be mate 9
        solveForMate("8/8/8/2K5/8/7k/1q6/8 b - - 0 1", "b2c3", willMateIn(14))
        // should be mate 6
        solveForMate("8/8/8/3q4/K5k1/8/8/8 w - - 0 1", "a4b4", willBeMatedIn(7))
    }
    ...
    @Throws(IllegalFenException::class, InterruptedException::class)
    fun testBestMoves() {
        assertBestMove("8/4k3/8/8/2p2P2/8/2P5/5K2 b - - 0 1", "e7e6", -222);
        assertBestMove("k7/5RP1/1P6/1K6/6r1/8/8/8 b - -", "g4g1", -1461);
        assertBestMove("5k2/5p1p/p3B1p1/P5P1/3K1P1P/8/8/8 b - -", "f7e6", -249);
        assertBestMove("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67", "b1b7", 9995);
        assertBestMove("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", "g2h1q", 1237);
        ...
        assertBestMove("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", "b4f4", 39);
    ...
    @Throws(IllegalFenException::class, InterruptedException::class)
    fun testNodeCount() {
        assertNodeCount("5k2/5p1p/p3B1p1/P5P1/3K1P1P/8/8/8 b - -", 3539);
        assertNodeCount("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67", 3195);
        assertNodeCount("8/7p/p5pb/4k3/P1pPn3/8/P5PP/1rB2RK1 b - d3 0 28", 11897);
        assertNodeCount("rnbqkb1r/ppppp1pp/7n/4Pp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 3", 90135);
        assertNodeCount("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 52418);
        assertNodeCount("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 177484);
        assertNodeCount("6k1/p5p1/5p2/2P2Q2/3pN2p/3PbK1P/7P/6q1 b - -", 142896);
        assertNodeCount("8/k1b5/P4p2/1Pp2p1p/K1P2P1P/8/3B4/8 w - -", 3375);
        assertNodeCount("3r2k1/ppp2ppp/6q1/b4n2/3nQB2/2p5/P4PPP/RN3RK1 b - -", 204248);
        assertNodeCount("4r3/1Q1qk2p/p4pp1/3Pb3/P7/6PP/5P2/4R1K1 w - -", 211256);
        assertNodeCount("k7/5RP1/1P6/1K6/6r1/8/8/8 b - -", 34184);
        assertNodeCount("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", 28433);
    }
