...
class SearchTest {
    ...
    fun testQueenVKingEndGameDodgyPositions() {
        solveForMate("8/8/8/4q3/1K6/7k/8/8 b - - 0 1", "h3g4", MATE_8, true) // h3g2 gives mate in 8
        solveForMate("8/8/8/8/2K5/7k/1q6/8 b - - 0 1", "h3g4", MATE_9, true) // b2b6, b2e5
        solveForMate("8/8/8/8/5q2/K7/3k4/8 b - - 0 1", "d2c2", MATE_2)
        solveForMate("8/8/8/8/5q2/1K6/4k3/8 b - - 0 1", "e2d3", MATE_4, true) // e2d2
        solveForMate("8/8/8/8/5q2/2K5/5k2/8 b - - 0 1", "f2e3", MATE_5, true) // f4a4
        solveForMate("8/8/8/4q3/8/3K4/5k2/8 b - - 0 1", "e5b5", MATE_6, true) // e5f4, e5c5
        solveForMate("8/8/1K6/4q3/8/7k/8/8 b - - 0 1", "e5d4", MATE_7, true) // h3g4, e5d5
        solveForMate("8/8/8/4q3/2K5/8/6k1/8 b - - 0 1", "g2f2", MATE_7, true) // also e5a5
        solveForMate("8/8/8/2K5/8/7k/1q6/8 b - - 0 1", "b2c3", MATE_9, true) // also h3g4, b2b3, h3g3, b2e5
    }

    @Test
    @Throws(IllegalFenException::class, InterruptedException::class)
    fun testBestMoves() {
        assertBestMove("8/4k3/8/8/2p2P2/8/2P5/5K2 b - - 0 1", "e7e6", -192);
        assertBestMove("k7/5RP1/1P6/1K6/6r1/8/8/8 b - -", "g4g1", -1462);
        assertBestMove("5k2/5p1p/p3B1p1/P5P1/3K1P1P/8/8/8 b - -", "f7e6", -249);
        assertBestMove("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67", "b1b7", 9995);
        assertBestMove("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", "g2h1q", 1271);
    ...
    fun testNodeCount() {
        ...
        assertNodeCount("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67", 116122);
        assertNodeCount("8/7p/p5pb/4k3/P1pPn3/8/P5PP/1rB2RK1 b - d3 0 28", 10714);
        ...
        assertNodeCount("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 169069);
        assertNodeCount("6k1/p5p1/5p2/2P2Q2/3pN2p/3PbK1P/7P/6q1 b - -", 88981);
        assertNodeCount("8/k1b5/P4p2/1Pp2p1p/K1P2P1P/8/3B4/8 w - -", 5721);
        assertNodeCount("3r2k1/ppp2ppp/6q1/b4n2/3nQB2/2p5/P4PPP/RN3RK1 b - -", 136499);
        assertNodeCount("4r3/1Q1qk2p/p4pp1/3Pb3/P7/6PP/5P2/4R1K1 w - -", 181705);
        assertNodeCount("k7/5RP1/1P6/1K6/6r1/8/8/8 b - -", 63462);
        assertNodeCount("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", 28725);
    }
