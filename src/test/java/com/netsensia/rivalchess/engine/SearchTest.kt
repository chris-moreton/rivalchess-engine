...
class SearchTest {
    ...
    fun testQueenVKingEndGameDodgyPositions() {
        solveForMate("8/8/8/4q3/1K6/7k/8/8 b - - 0 1", "e5d4", MATE_8, false) // h3g2 gives mate in 8
        solveForMate("8/8/8/8/2K5/7k/1q6/8 b - - 0 1", "b2a2", MATE_7, false) // b2b6, b2e5, h3g4, b2a2
        ...
        solveForMate("8/8/8/4q3/8/3K4/5k2/8 b - - 0 1", "e5d5", MATE_6, false) // e5f4, e5c5
        solveForMate("8/8/1K6/4q3/8/7k/8/8 b - - 0 1", "e5d6", MATE_8, false) // h3g4, e5d5
        solveForMate("8/8/8/4q3/2K5/8/6k1/8 b - - 0 1", "e5c7", MATE_7, false) // also e5a5
        solveForMate("8/8/8/2K5/8/7k/1q6/8 b - - 0 1", "b2e5", MATE_7, false) // also h3g4, b2b3, h3g3, b2e5
    }

    @Test
    @Throws(IllegalFenException::class, InterruptedException::class)
    fun testBestMoves() {
        assertBestMove("8/4k3/8/8/2p2P2/8/2P5/5K2 b - - 0 1", "e7e6", -230);
        assertBestMove("k7/5RP1/1P6/1K6/6r1/8/8/8 b - -", "g4g1", -1461);
        assertBestMove("5k2/5p1p/p3B1p1/P5P1/3K1P1P/8/8/8 b - -", "f7e6", -249);
        assertBestMove("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67", "b1b7", MATE_3);
    ...
    fun testNodeCount() {
        ...
        assertNodeCount("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67", 2761);
        ...
        assertNodeCount("6k1/p5p1/5p2/2P2Q2/3pN2p/3PbK1P/7P/6q1 b - -", 142887);
        assertNodeCount("8/k1b5/P4p2/1Pp2p1p/K1P2P1P/8/3B4/8 w - -", 3375);
        assertNodeCount("3r2k1/ppp2ppp/6q1/b4n2/3nQB2/2p5/P4PPP/RN3RK1 b - -", 204066);
