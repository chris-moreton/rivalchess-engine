...
public class EvaluateTest {
    ...
    private void assertEvaluationScore(String fen, int expectedScore, boolean flip) throws IllegalFenException {
        ...
        if (RECALCULATE) {
            ...
            assertEquals("Failed" + (!flip ? " on flip" : ""), expectedScore, actualScore);
    ...
    public void testEvaluationScores() throws IllegalFenException {
        assertEvaluationScore("8/8/8/8/5q2/2K5/5k2/8 b - - 0 1", 1431, true);
        ...
        assertEvaluationScore("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", 70, true); // @Todo Should be an exact draw
