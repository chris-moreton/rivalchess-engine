...
import com.netadapt.rivalchess.engine.EngineStub;
...
import com.netadapt.rivalchess.uci.UCIController;
...
//		System.out.println(Bitboards.directOpposition[3][26]);
		...
		make(engineBoard, "g1f3");		make(engineBoard, "e7e6");
		make(engineBoard, "d2d4");		make(engineBoard, "c5d4");
		make(engineBoard, "f3d4");		make(engineBoard, "a7a6");
		make(engineBoard, "f1d3");		make(engineBoard, "d8c7");
		make(engineBoard, "e1g1");		make(engineBoard, "g8f6");
		make(engineBoard, "b1d2");		make(engineBoard, "d7d5");
		make(engineBoard, "d1e2");		make(engineBoard, "d5e4");
		make(engineBoard, "d2e4");		make(engineBoard, "f8e7");
		make(engineBoard, "c1e3");		make(engineBoard, "e8g8");
		make(engineBoard, "e4f6");		make(engineBoard, "e7f6");
		make(engineBoard, "e2h5");		make(engineBoard, "g7g6");
		make(engineBoard, "h5f3");		make(engineBoard, "f6e5");
		make(engineBoard, "f3h3");		make(engineBoard, "c7d8");
		make(engineBoard, "d4f3");		make(engineBoard, "e5b2");
		make(engineBoard, "f3g5");		make(engineBoard, "h7h5");
		make(engineBoard, "a1d1");		make(engineBoard, "b8d7");
		make(engineBoard, "g5e6");		make(engineBoard, "f7e6");		
		make(engineBoard, "h3e6");		make(engineBoard, "f8f7");		
		make(engineBoard, "e6g6");		make(engineBoard, "f7g7");
		make(engineBoard, "g6h5");      make(engineBoard, "d8c7");
		make(engineBoard, "h5d5");		make(engineBoard, "g8h8");		
		make(engineBoard, "d5h5");		make(engineBoard, "h8g8");
		make(engineBoard, "h5d5");		make(engineBoard, "g8h8");		
		make(engineBoard, "d5h5");	    make(engineBoard, "h8g8");
	...
	public static void threadTest()
	{
		...
		threadEngine.setMillisToThink(2000);
		threadEngine.startEngineTimer(true);
	...
	public static void rivalVersusRival()
	{
